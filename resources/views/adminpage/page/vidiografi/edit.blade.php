    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Videografi</h5>

                        <!-- General Form Elements -->
                        <form action="{{ route('vidiografi.update',['id' => $vidiografi->id]) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('vidio') is-invalid @enderror"
                                        name="vidio" value="{{ old('vidio', $vidiografi->vidio) }}"
                                        placeholder="Masukkan video" required>
